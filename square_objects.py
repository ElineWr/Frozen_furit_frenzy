...
all_squares = [
    ...
    Square(farge = RED, x = WIDTH - 50, y = 0, width = 50, height = (HEIGHT*(4/8)), background = 0),
    Square(farge = BLUE, x = WIDTH - 50, y = (HEIGHT*(6/8)), width = 50, height = (HEIGHT*(2/8)), background = 0),
    Square(farge = GREEN, x = 0, y = 0, width = WIDTH, height = (HEIGHT*(1.5/8)), background = 0),
    ...
    Square(farge = RED, x = 0, y = 0, width=350, height=50, background=1),
    ...
    Square(farge = BLACK, x = 0, y = HEIGHT - 50, width = 300, height = 50, background=2),
    ...
    Square(farge = BLACK, x = 0, y = HEIGHT-100, width=WIDTH*(5/10), height=100, background=3),
    Square(farge = BLACK, x = WIDTH - 200, y = 0, width=200, height=75, background=3),
    Square(farge = BLACK, x = WIDTH - 300, y = 0, width= 300, height= 50, background=3),
    Square(farge = BLACK, x = WIDTH - 175, y = HEIGHT*(5.5/10), width=175, height=175, background=3),
    Square(farge = BLACK, x = WIDTH - 50, y = HEIGHT*(1/10), width=50, height = 300, background=3)
